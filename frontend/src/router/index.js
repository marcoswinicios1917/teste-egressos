...
// Novos imports para as páginas de egressos
import EgressoList from "@/views/EgressoList.vue"; // Listagem de egressos
import EgressoDetail from "@/views/EgressoDetail.vue"; // Detalhes de um egresso específico
...
const router = createRouter({
  ...
  routes: [
    ...
    // Novas rotas para egressos
    {
      path: "/egressos",
      name: "egresso-list",
      component: EgressoList,
    },
    {
      path: "/egresso/:id",
      name: "egresso-detail",
      component: EgressoDetail,
      props: true, // Passa o ID do egresso como uma prop
    },
  ],
});
